        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Supercharge your CRM with AI agents that work 24/7 to automate your sales, 
              marketing, and customer success workflows.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">AI Agents</a></li>
